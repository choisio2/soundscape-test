...
class PlaylistResultAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return if (viewType == TYPE_SONG) {
            ...
            val view = inflater.inflate(R.layout.item_listmode, parent, false)
            SongViewHolder(view)
        } else {
            // item_playlist_footer.xml 레이아웃 사용
            val view = inflater.inflate(R.layout.item_playlist_footer, parent, false)
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        if (holder is SongViewHolder) {
            ...
            holder.itemView.setOnClickListener { onFooterClick() }
        }
    }
